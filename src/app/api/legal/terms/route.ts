...
export async function GET() {
  try {
    // Static HTML content for terms and conditions
    const content = `
      <div class="max-w-3xl mx-auto">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4">Job Listings and Applications</h2>
          <h3 class="text-xl font-medium mb-3">For Employers</h3>
          <p class="mb-4">
          ...
          <h3 class="text-xl font-medium mb-3 mt-6">For Job Seekers</h3>
          <p class="mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4">Disclaimer of Warranties</h2>
          <p class="mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4">Modifications to Terms</h2>
          <p class="mb-4">
    ...
    return NextResponse.json(
      { error: "Failed to load terms and conditions", success: false },
      { status: 500 }
    );
  }
}
